...
const API_URL =
  ...
  "https://manutencao-industrial-julio.squareweb.app";
...
export default function App() {
  ...
  const [usuario, setUsuario] = useState(
    () => localStorage.getItem("maint_user") || "Julio",
  );
  ...
  const exportPDF = (item) => {
    ...
    autoTable(doc, {
      ...
      body: [
        [
          "Severidade",
          (item.severity || rawData.severity || "N/A").toUpperCase(),
        ],
        ["Componente Foco", rawData.componente_foco || "Geral"],
        [
          "Parecer Técnico",
          rawData.summary || item.diagnosis || "Não disponível",
        ],
    ...
    >
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: "20px" }}>
          ...
          <div style={{ textAlign: "left" }}>
            <h1 style={{ margin: 0, fontSize: "24px" }}>
              Diagnóstico de Manutenção Industrial
            </h1>
        ...
        <div style={{ textAlign: "right" }}>
          <label style={{ fontSize: "12px", display: "block", opacity: 0.8 }}>
            TÉCNICO RESPONSÁVEL
          </label>
          <input
            type="text"
        ...
        {["diagnóstico", "histórico", "dashboard"].map((t) => (
          <button
            ...
            style={{
              ...
              background: "none",
              cursor: "pointer",
              borderBottom: activeTab === t ? "4px solid #004a8c" : "none",
      ...
      >
          ...
          >
            ...
            >
              ...
              <input
                ...
                placeholder="Ex: Bomba de Recalque 02"
                required
              />

              <label style={{ fontWeight: "bold", color: "#555" }}>
                Relato de Sintomas / Anomalias
              </label>
              <textarea
                style={{
                  width: "100%",
                ...
                placeholder="Descreva ruídos, vibrações, temperatura ou falhas elétricas..."
                required
              />
            ...
            >
              ...
              >
                <h2 style={{ color: "#004a8c", margin: 0 }}>
                  Resultado da Análise
                </h2>
                {diagnosis && (
                  <button
                    onClick={() => exportPDF(diagnosis)}
                    style={{
                      background: "#52c41a",
                      color: "#fff",
                      border: "none",
              ...
              {diagnosis ? (
                <div style={{ marginTop: "20px", lineHeight: "1.6" }}>
                  <p>
                    ...
                    <span
                      style={{
                        color:
                          diagnosis.severity === "critical" ? "red" : "#faad14",
                        fontWeight: "bold",
                      }}
                    >
                  ...
                  <p>
                    <strong>Parecer:</strong> {diagnosis.summary}
                  </p>
                  <div
                    style={{
                      background: "#f9f9f9",
                  ...
                  >
                    <p>
                      <strong>Impacto:</strong> {diagnosis.impacto_operacional}
                    </p>
                    <p>
                      <strong>Segurança:</strong> {diagnosis.seguranca_loto}
                    </p>
                  </div>
                </div>
              ) : (
                ...
                >
                  Aguardando entrada para diagnóstico...
                </p>
              )}
            </section>
          </div>
        ...
        {activeTab === "histórico" && (
          ...
          >
            <h2 style={{ color: "#004a8c", marginBottom: "25px" }}>
              ...
              <tbody>
                {history.map((h) => (
                  <tr key={h.id} style={{ borderBottom: "1px solid #eee" }}>
                    ...
                    <td
                      style={{
                        color: h.severity === "critical" ? "red" : "#faad14",
                        fontWeight: "600",
                      }}
                    >
                      {h.severity}
        ...
        {activeTab === "dashboard" && (
          ...
          >
            ...
            >
              <h3 style={{ color: "#004a8c", marginBottom: "30px" }}>
                Severidade em {usuario}
              </h3>
              <div
                style={{
                  width: "200px",
            ...
            >
              <h3 style={{ color: "#004a8c", marginBottom: "25px" }}>
                Volume por Equipamento
              </h3>
              {Array.from(new Set(history.map((h) => h.equipment))).map(
                (equip) => {
